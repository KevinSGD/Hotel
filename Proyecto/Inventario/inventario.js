...
// Esta función sería llamada desde el módulo de ventas cuando se registra un consumo
function registrarConsumoEnInventario(productoNombre, cantidad) {
  ...
  if (producto && producto.stock >= cantidad) {
    ...
    // Actualizar interfaz si estamos en el módulo de inventario
    cargarDashboardInventario()
    cargarTablaExistencias()
    cargarTablaMovimientos()
